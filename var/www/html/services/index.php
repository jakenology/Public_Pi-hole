<?php
// https://github.com/truongan/php.server.status
/*
...
$services[] = array("port" => "22",       "service" => "SSH Login",                              "ip" => "") ;
$services[] = array("port" => "53",       "service" => "Pi-hole DNS",  "ip" => "") ;
$services[] = array("port" => "80",       "service" => "Pi-hole Admin Interface",                  "ip" => "") ;
$services[] = array("port" => "80",       "service" => "Outbound Connection",     "ip" => "google.com") ;
$services[] = array("port" => "443",      "service" => "Admin Pi-hole Interface - HTTPS", "ip" => "");
